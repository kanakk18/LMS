    ...
    <footer className='bg-gray-900 md:px-36 text-left w-full mt-10'>
      <div className='flex flex-col md:flex-row items-start px-8 md:px-0 justify-center gap-10 md:gap-32 py-10 border-b border-white/30'>
        ...
        <div className='flex flex-col w-full md:items-start items-center'>
          ...
          <ul className='flex flex-col text-sm text-white/80 space-y-2 items-start'>
            <li><a href="#">Home</a></li>
      ...
      <p className='py-4 text-center text-xs md:text-sm text-white/60'>Copyright 2025 &copy; GreatSatck. All Right Reserved </p>
    </footer>
  )
}
